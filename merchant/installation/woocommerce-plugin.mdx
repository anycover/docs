...
## Download the plugin
To get started with enabling Anycover on Woocommerce, please download the Anycover plugin package first. [Click here](https://de03r9gaxziou.cloudfront.net/zip/Anycover-WC-Plugin-V1-0-3.zip) to automatically download the zipped file.
