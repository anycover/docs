...
description: "Steps to install Anycover plugin on your shopify store"
---

## Download and Installing the plugin
-   Log in to your Shopify account.

-   To get started with enabling Anycover on your shopify store add the Anycover plugin from [here](https://apps.shopify.com/anycover). (Click on the Add app button)
